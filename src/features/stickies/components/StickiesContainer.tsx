...
export function StickiesContainer() {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto min-h-0 grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8 py-4 md:py-6 pl-10 lg:pl-10 pr-2 lg:pr-4 stickies-scrollbar content-start auto-rows-min">
        {/* Left column */}
        <Reorder.Group
          axis="y"
          values={leftIds}
